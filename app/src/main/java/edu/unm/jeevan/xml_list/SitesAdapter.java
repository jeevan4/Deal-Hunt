 ...
 */
public class SitesAdapter extends ArrayAdapter<EbayData> {

    ImageLoader imageLoader;
    DisplayImageOptions options;


    public SitesAdapter(Context ctx, int textViewResourceId, List<EbayData> sites) {
    ...
    public View getView(int pos, View convertView, ViewGroup parent){
        ...
        if(null == row){
            ...
            row = (RelativeLayout)inflater.inflate(R.layout.row_list, null);
        }

        //Get our View References
        final ImageView iconImg = (ImageView)row.findViewById(R.id.iconImg);
        TextView nameTxt = (TextView)row.findViewById(R.id.nameTxt);
        TextView priceNow = (TextView)row.findViewById(R.id.priceNow);
        TextView savings = (TextView)row.findViewById(R.id.savings);
        ...
        priceNow.setText("$"+ getItem(pos).getPricenow());
        savings.setText("   You Save " + getItem(pos).getSavings());
